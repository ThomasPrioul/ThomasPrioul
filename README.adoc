...
- French and English : I'm fluent in both, you can have me in your meeting, I won't embarass you. I'm a developer but I don't only wear hoodies in dark rooms (a common misconception here in french big companies).
- *Web frontends (Angular/HTML/TailwindCSS/daisyUI/MaterialUI) : my current tech stack at work*. Not to brag, but I'm the go-to guy for all UI/UX/CSS questions at my office. See <<MDL angular lib>> below for reference.
